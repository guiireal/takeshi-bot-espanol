...
export default {
  name: "enviar-reels",
  description: "Ejemplo de como enviar reels em Rich Response",
  ...
  handle: async ({ socket, remoteJid, webMessage, sendReply, sendReact }) => {
    ...
    await sendReply(
      "Esse ejemplo usa `messageType: 9` com `contentItemsMetadata.itemsMetadata[].reelItem` e también preenche as fontes em `richResponseSourcesMetadata`.",
    );
  },
};
