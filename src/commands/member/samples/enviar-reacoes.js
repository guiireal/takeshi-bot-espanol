...
export default {
  name: "enviar-reacoes",
  description: "Ejemplo de diferentes tipos de reações (emojis)",
  ...
  handle: async ({
    ...
    await sendReply("Voy demonstrar diferentes tipos de reações disponibles:");
