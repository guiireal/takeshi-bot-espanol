...
export default {
  name: "removebg",
  description: "Elimina el fondo de imágenes e stickers.",
  commands: ["removebg", "rmbg", "remove-bg"],
  usage: `${PREFIX}removebg (marque ou responda uma imagen/sticker)`,
  /**
  ...
  handle: async ({
    ...
    if (!isImage && !isSticker) {
      throw new InvalidParameterError(
        "Debes mencionar o responder uma imagen ou sticker!",
      );
    }
