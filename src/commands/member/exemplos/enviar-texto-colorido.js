...
export default {
  ...
  description: "Ejemplo de como enviar texto colorido em Rich Response",
  ...
  handle: async ({
    ...
    await sendReply(
      "Esse ejemplo usa `richResponseMessage` com `AI_RICH_RESPONSE_TEXT`. O destaque amarelo tenta seguir o Markdown `# ==( texto )==`.",
    );
  },
};
