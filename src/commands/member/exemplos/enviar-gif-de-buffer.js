...
export default {
  ...
  description: "Ejemplo de como enviar gifs a partir de buffers",
  ...
  handle: async ({ sendReply, sendGifFromBuffer, sendReact, userLid }) => {
    ...
    await sendReply(
      "Voy enviar gifs a partir de buffers (archivo local e URL)"
    );
    ...
    await sendReply("Ahora de um buffer obtido de uma URL:");
    ...
    await sendReply(
      "Para enviar imágenes de archivo, use a función sendGifFromBuffer(buffer, caption, [mentions], quoted).\n\n" +
