...
declare class NodeCacheStore<T> extends Hookified {
   ...
   * @returns {boolean}
   */
  get useClones(): boolean;
  /**
   * Whether to clone values on get/set.
   * @param {boolean} value
   */
  set useClones(value: boolean);
  /**
   * Whether to delete expired items when detected.
   * @returns {boolean}
   */
  get deleteOnExpire(): boolean;
  /**
   * Whether to delete expired items when detected.
   * @param {boolean} value
   */
  set deleteOnExpire(value: boolean);
  /**
   * The Keyv store instance.
   * @returns {Keyv<T>}
   * @readonly
   ...
   */
  startInterval(checkperiod?: number): void;
  /**
...
//#endregion
export { NodeCache, NodeCache as default, NodeCacheErrors, NodeCacheItem, NodeCacheOptions, NodeCacheStats, NodeCacheStore, type NodeCacheStoreOptions, PartialNodeCacheItem };